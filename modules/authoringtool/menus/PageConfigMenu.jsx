 ...
 * configurationChangedCallback�� callback when change setting
 *
 * state
 *
 */
    ...
    render: function () {
        return (
            <div className="pageConfig" style={{
                ...
                <div><input checked={this.props.pageSetting.showHeader} type="checkbox"
                            onChange={this.toggleHeader}/><span>Show Header</span></div>
