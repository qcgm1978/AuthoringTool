...
var PageToolWorkspace = React.createClass({
    getInitialState: function () {
        return {
            themeName: "default",
            pageSetting: {
                /**the grid layout setting  it will effect the axisline so defined here*/
                width: 1024,
                height: 768,
                doubleScreen: false,
                expandMode: 1,
    ...
    render: function () {
        return (
            <div className="tool-workspace" onClick={this.onclick}>
                <LeftMenu ref="leftmenu" configurationChangedCallback={this.pageSettingChanged}
                          pageSetting={this.state.pageSetting}/>

                <ThemedPage ref="page" data={this.props.data} themeName={this.state.themeName}
                            doubleScreen={this.state.pageSetting.doubleScreen} pageSetting={this.state.pageSetting}/>
                ...
                <AxisLines width={this.state.pageSetting.width} height={this.state.pageSetting.height}
                           ...
                           expandMode={this.state.pageSetting.expandMode}/>
            </div>
        );
    }
});
